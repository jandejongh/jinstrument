package org.javajdj.jinstrument.r1.instrument.sa.hp70000;
...
implements SpectrumAnalyzer
{
  ...
  private static final Logger LOG = Logger.getLogger (HP70000_GPIB.class.getName ());
  ...
  public HP70000_GPIB (final GpibDevice device)
  {
    super ("HP70000", device, null, null);
