 ...
 *
 */
public class JOscilloscopeTraceDisplay
extends JPanel
implements OscilloscopeClient
{
  ...
  private static final Logger LOG = Logger.getLogger (JOscilloscopeTraceDisplay.class.getName ());
  ...
  public JOscilloscopeTraceDisplay (final JOscilloscopeManagedTraceDisplay manager)
  {
    super ();
  ...
  private volatile OscilloscopeTrace trace = null;
  
  public final synchronized void setTrace (final OscilloscopeTrace trace)
  {
    this.trace = trace;
...
//  }
  ...
  private void paintGraticule (final Graphics2D g2d, final OscilloscopeTrace trace, final int width, final int height)
  {
...
//      }
  ...
  (final Graphics2D g2d, final OscilloscopeTrace trace,
...
//  private void paintResolutionBandwith (final Graphics2D g2d, final OscillTrace trace, final int width, final int height)
//  {
...
//  }
  ...
  (final Graphics2D g2d, final OscilloscopeTrace trace, final Color color, final int width, final int height)
  {
...
//        double y_s = (((referenceLevel_dBm - trace.getSamples ()[s]) / 100.0) * height);
        // XXX
        // final double x_s = f_MHzToX (f_MHz_s); // XXX Use width??
        final double x_s = ((double) getWidth ()) * s / ((double) this.trace.getSettings ().getTraceLength () - 1.0);
        // XXX
        // double y_s = (((referenceLevel_dBm - trace.getSamples ()[s]) / 100.0) * height);
        double y_s = (((5.0 - trace.getSamples ()[s]) / 10.0) * height);
...
//      return;
//    final double referenceLevel_dBm = trace.getSettings ().getReferenceLevel_dBm ();
//    final double kTRB_W = JOscilloscopeTraceDisplay.BOLTZMAN_K
//      * JOscilloscopeTraceDisplay.T
...
//    paintHighestPeak (g2d, trace, width, height);
  ...
  public void paintComponent (final Graphics g)
  {
    ...
    final OscilloscopeTrace trace = this.trace;
...
//  }
  ...
  private final MouseAdapter mouseAdapter = new MouseAdapter ()
  {
    ...
    {
      JOscilloscopeTraceDisplay.this.drawCrossHair = false;
      JOscilloscopeTraceDisplay.this.repaint ();
    }

    @Override
    public void mouseEntered (final MouseEvent e)
    {
      JOscilloscopeTraceDisplay.this.mouseX = e.getX ();
      JOscilloscopeTraceDisplay.this.mouseY = e.getY ();
      JOscilloscopeTraceDisplay.this.drawCrossHair = true;
      JOscilloscopeTraceDisplay.this.repaint ();
    }
    ...
    {
//      if (JOscilloscopeTraceDisplay.this.manager != null)
//      {
//        final int x = e.getX ();
//        final int y = e.getY ();
...
//            JOscilloscopeTraceDisplay.this.manager.mouseButton1Clicked (f_MHz, S_dBm);
//            break;
//          case MouseEvent.BUTTON2:
//            JOscilloscopeTraceDisplay.this.manager.mouseButton2Clicked (f_MHz, S_dBm);
//            break;
//          case MouseEvent.BUTTON3:
//            JOscilloscopeTraceDisplay.this.manager.mouseButton3Clicked (f_MHz, S_dBm);
//            break;
//          default:
//            break;
//        }
//      }
    ...
    {
      JOscilloscopeTraceDisplay.this.mousePressX = e.getX ();
      JOscilloscopeTraceDisplay.this.mousePressY = e.getY ();
    }
    ...
    public void mouseReleased (final MouseEvent e)
    {
      if (JOscilloscopeTraceDisplay.this.manager != null)
      {
//        final int x1 = JOscilloscopeTraceDisplay.this.mousePressX;
//        final int x2 = e.getX ();
//        final int y1 = JOscilloscopeTraceDisplay.this.mousePressY;
//        final int y2 = e.getY ();
...
//        {
//          case MouseEvent.BUTTON1:
//            JOscilloscopeTraceDisplay.this.manager.mouseButton1Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          case MouseEvent.BUTTON2:
//            JOscilloscopeTraceDisplay.this.manager.mouseButton2Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          case MouseEvent.BUTTON3:
//            JOscilloscopeTraceDisplay.this.manager.mouseButton3Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          default:
//            break;
//        }
