...
import org.javajdj.jinstrument.r1.instrument.dso.OscilloscopeClient;
 ...
 *
 */
public class JOscilloscopeManagedTraceDisplay
extends JPanel
implements OscilloscopeClient
{
  ...
  private static final Logger LOG = Logger.getLogger (JOscilloscopeManagedTraceDisplay.class.getName ());
  ...
  public JOscilloscopeManagedTraceDisplay (final Oscilloscope oscilloscope)
  {
    super ();
    ...
    this.display = new JOscilloscopeTraceDisplay (this);
    add (this.display, BorderLayout.CENTER);
    this.statusBar = new StatusBar ();
    add (this.statusBar, BorderLayout.WEST);
    this.control = new JOscilloscopeControl (this);
    add (this.control, BorderLayout.EAST);
  ...
  private final JOscilloscopeTraceDisplay display;
  ...
  private final JOscilloscopeControl control;
  ...
  {
    return this.oscilloscope.getChannelIds ();
  }
  ...
  private final SpectrumAnalyzerTrace[] traceHistory
    = new SpectrumAnalyzerTrace[JOscilloscopeManagedTraceDisplay.MAX_TRACE_HISTORY];
  ...
  private void addTraceToHistory (final SpectrumAnalyzerTrace trace)
  {
    ...
    if (this.lastTraceIndexInHistory == JOscilloscopeManagedTraceDisplay.MAX_TRACE_HISTORY)
    {
    ...
    final int endIndex =
      this.traceHistoryFilled ? (JOscilloscopeManagedTraceDisplay.MAX_TRACE_HISTORY - 1) : this.lastTraceIndexInHistory;
  ...
  extends Thread
  {
    ...
    private volatile OscilloscopeTraceSettings traceSettings = null;
    ...
    public final void run ()
    {
      while (! isInterrupted ())
      {
        try
        {
          ...
          final OscilloscopeTraceSettings traceSettingsCopy;
          ...
          final OscilloscopeTrace trace = JOscilloscopeManagedTraceDisplay.this.oscilloscope.getTrace
                                            (getChannelIds ().get (0), traceSettingsCopy);
//            JOscilloscopeManagedTraceDisplay.this.spectrumAnalyzer.getTrace (traceSettingsCopy);
          // XXX
//          synchronized (this)
//          {
...
//          }
          ...
          JOscilloscopeManagedTraceDisplay.this.newTraceFromOscilloscope (trace);
        }
        catch (InterruptedException ie)
        {
          LOG.log (Level.WARNING, "InterruptedException: {0}.", ie.getMessage ());
          JOscilloscopeManagedTraceDisplay.this.setTraceThread (null);
          return;
        }
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //
  // METHOD newTraceFromOscilloscope
  //
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  
  private synchronized void newTraceFromOscilloscope (final OscilloscopeTrace trace)
  {
    if (trace == null)
      throw new IllegalArgumentException ();
...
//        }
  ...
  private class StatusBar extends JPanel
  {
    ...
    public StatusBar ()
    {
      ...
      this.acqThreadCheckBox.setSelected (JOscilloscopeManagedTraceDisplay.this.isRunningTraceThread ());
        ...
        public void mouseClicked (final MouseEvent e)
        {
          switch (e.getButton ())
          {
            case MouseEvent.BUTTON1:
              synchronized (JOscilloscopeManagedTraceDisplay.this)
              {
                if (isRunningTraceThread ())
                  JOscilloscopeManagedTraceDisplay.this.disposeTraceThread ();
                else
                  JOscilloscopeManagedTraceDisplay.this.startTraceThread (true);
              }
              break;
      ...
      this.cfTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setCenterFrequency_MHz (conversionFactor * fMHz);
          }
        }
      });
      ...
      this.spTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setSpan_MHz (conversionFactor * span_MHz);
          }
        }
      });
      ...
      this.rbLabel.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          JOscilloscopeManagedTraceDisplay.this.setAutoResolutionBandwidth ();
        }
      });
      ...
      this.rbTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setResolutionBandwidth_Hz (conversionFactor * rb_Hz);
          }
        }
      });
      ...
      this.vbLabel.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          JOscilloscopeManagedTraceDisplay.this.setAutoVideoBandwidth ();
        }
      });
      ...
      this.vbTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setVideoBandwidth_Hz (conversionFactor * vb_Hz);
          }
        }
      });
      ...
      this.stLabel.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          JOscilloscopeManagedTraceDisplay.this.setAutoSweepTime ();
        }
      });
      ...
      this.stTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setSweepTime_s (conversionFactor * st_s);
          }
        }
      });
      ...
      this.tlTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setTraceLength (tl_s);
          }
        }
      });
      ...
      this.rlTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setReferenceLevel_dBm (conversionFactor * rl_dBm);
          }
        }
      });
      ...
      this.atTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            ...
            JOscilloscopeManagedTraceDisplay.this.setAttenuation_dB (conversionFactor * at_dB);
          }
        }
      });
      ...
      this.detTextField.addMouseListener (new MouseAdapter ()
      {
        ...
        public void mouseClicked (final MouseEvent e)
        {
          ...
          if (inputString != null)
          {
            if (! JOscilloscopeManagedTraceDisplay.this.setDetectorFromString (inputString))
            {
              JOptionPane.showMessageDialog
                (null, "Illegal value " + inputString + "!", "Illegal Input", JOptionPane.ERROR_MESSAGE);
              return;
      ...
      this.latestCheckBox.setSelected (JOscilloscopeManagedTraceDisplay.this.display.isEnableTrace ());
      this.latestCheckBox.addItemListener ((final ItemEvent e) ->
      {
        JOscilloscopeManagedTraceDisplay.this.display.setEnableTrace (e.getStateChange () == ItemEvent.SELECTED);
      });
      ...
      this.avgCheckBox.setSelected (JOscilloscopeManagedTraceDisplay.this.display.isEnableAvgTrace ());
      this.avgCheckBox.addItemListener ((final ItemEvent e) ->
      {
        JOscilloscopeManagedTraceDisplay.this.display.setEnableAvgTrace (e.getStateChange () == ItemEvent.SELECTED);
      });
      ...
      this.avgFCheckBox.setSelected (JOscilloscopeManagedTraceDisplay.this.display.isEnableAvgFTrace ());
      this.avgFCheckBox.addItemListener ((final ItemEvent e) ->
      {
        JOscilloscopeManagedTraceDisplay.this.display.setEnableAvgFTrace (e.getStateChange () == ItemEvent.SELECTED);
      });
    ...
    protected void updateComponent (final OscilloscopeTraceSettings settings, final OscilloscopeTrace trace)
    {
...
//          StatusBar.this.detTextField.setText (settings.getDetector ().getFourCharString ());
    ...
    protected void updateComponent ()
    {
      SwingUtilities.invokeLater (() ->
      {
          StatusBar.this.acqThreadCheckBox.setSelected (JOscilloscopeManagedTraceDisplay.this.isRunningTraceThread ());
      });
    }
  }
