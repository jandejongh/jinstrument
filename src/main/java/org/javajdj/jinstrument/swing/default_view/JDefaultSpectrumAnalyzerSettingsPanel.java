 ...
 *
 */
public class JDefaultSpectrumAnalyzerSettingsPanel
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JDefaultSpectrumAnalyzerSettingsPanel.class.getName ());
  ...
  public JDefaultSpectrumAnalyzerSettingsPanel (
  ...
  public JDefaultSpectrumAnalyzerSettingsPanel (final SpectrumAnalyzer spectrumAnalyzer)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof SpectrumAnalyzer))
        return new JDefaultSpectrumAnalyzerSettingsPanel ((SpectrumAnalyzer) instrument);
      else
        return null;
    }
  ...
  {
    return JDefaultSpectrumAnalyzerSettingsPanel.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
  ...
  private final InstrumentListener instrumentListener = new InstrumentListener ()
  {
    ...
    public void newInstrumentSettings (final Instrument instrument, final InstrumentSettings instrumentSettings)
    {
      ...
      {
        JDefaultSpectrumAnalyzerSettingsPanel.this.inhibitInstrumentControl = true;
        //
        try
        {
          if (instrumentSettings == null)
          {
            JDefaultSpectrumAnalyzerSettingsPanel.this.jCenterFrequency_MHz.setBlank ();        
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSpan_MHz.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jResolutionBandwidth_Hz.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jResolutionBandwidthCoupled.setDisplayedValue (null);
            JDefaultSpectrumAnalyzerSettingsPanel.this.jVideoBandwidth_Hz.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jVideoBandwidthCoupled.setDisplayedValue (null);
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSweepTime_s.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSweepTimeCoupled.setDisplayedValue (null);
            JDefaultSpectrumAnalyzerSettingsPanel.this.jReferenceLevel_dBm.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jRfAttenuation_dB.setBlank ();
            JDefaultSpectrumAnalyzerSettingsPanel.this.jRfAttenuationCoupled.setDisplayedValue (null);
          }
          else
          {
            ...
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSpan_MHz.setNumber (
              settings.getSpan_MHz ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jResolutionBandwidth_Hz.setNumber (
              settings.getResolutionBandwidth_Hz ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jResolutionBandwidthCoupled.setDisplayedValue (
              settings.isResolutionBandwidthCoupled ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jVideoBandwidth_Hz.setNumber (
              settings.getVideoBandwidth_Hz ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jVideoBandwidthCoupled.setDisplayedValue (
              settings.isVideoBandwidthCoupled ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSweepTime_s.setNumber (
              settings.getSweepTime_s ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jSweepTimeCoupled.setDisplayedValue (
              settings.isSweepTimeCoupled ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jReferenceLevel_dBm.setNumber (
              settings.getReferenceLevel_dBm ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jRfAttenuation_dB.setNumber (
              settings.getRfAttenuation_dB ());
            JDefaultSpectrumAnalyzerSettingsPanel.this.jRfAttenuationCoupled.setDisplayedValue (
              settings.isRfAttenuationCoupled ());
          }
        }
        finally
        {
          JDefaultSpectrumAnalyzerSettingsPanel.this.inhibitInstrumentControl = false;
        }
      });
    }
