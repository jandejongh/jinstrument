 ...
 * 
 */
public class JDefaultSpectrumAnalyzerTraceDisplay
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JDefaultSpectrumAnalyzerTraceDisplay.class.getName ());
  ...
  public JDefaultSpectrumAnalyzerTraceDisplay (final SpectrumAnalyzer spectrumAnalyzer, final int level)
  {
  ...
  public JDefaultSpectrumAnalyzerTraceDisplay (final SpectrumAnalyzer spectrumAnalyzer)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof SpectrumAnalyzer))
        return new JDefaultSpectrumAnalyzerTraceDisplay ((SpectrumAnalyzer) instrument);
      else
        return null;
    }
  ...
  {
    return JDefaultSpectrumAnalyzerTraceDisplay.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
...
//  
  ...
  private final InstrumentListener instrumentListener = new InstrumentListener ()
  {
    ...
    {
      if (instrument != JDefaultSpectrumAnalyzerTraceDisplay.this.getSpectrumAnalyzer ())
        return;
      JDefaultSpectrumAnalyzerTraceDisplay.this.setTrace ((SpectrumAnalyzerTrace) instrumentReading);
    }
...
//      return;
//    final double referenceLevel_dBm = trace.getInstrumentSettings ().getReferenceLevel_dBm ();
//    final double kTRB_W = JDefaultSpectrumAnalyzerTraceDisplay.BOLTZMAN_K
//      * JDefaultSpectrumAnalyzerTraceDisplay.T
...
//  private int mousePressY = -1;
  ...
  private final MouseAdapter mouseAdapter = new MouseAdapter ()
  {
    ...
    {
      JDefaultSpectrumAnalyzerTraceDisplay.this.drawCrossHair = false;
      JDefaultSpectrumAnalyzerTraceDisplay.this.repaint ();
    }

    @Override
    public void mouseEntered (final MouseEvent e)
    {
      JDefaultSpectrumAnalyzerTraceDisplay.this.mouseX = e.getX ();
      JDefaultSpectrumAnalyzerTraceDisplay.this.mouseY = e.getY ();
      JDefaultSpectrumAnalyzerTraceDisplay.this.drawCrossHair = true;
      JDefaultSpectrumAnalyzerTraceDisplay.this.repaint ();
    }
...
//    {
//      if (JDefaultSpectrumAnalyzerTraceDisplay.this.manager != null)
//      {
//        final int x = e.getX ();
//        final int y = e.getY ();
...
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton1Clicked (f_MHz, S_dBm);
//            break;
//          case MouseEvent.BUTTON2:
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton2Clicked (f_MHz, S_dBm);
//            break;
//          case MouseEvent.BUTTON3:
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton3Clicked (f_MHz, S_dBm);
//            break;
//          default:
//            break;
//        }
...
//    {
//      JDefaultSpectrumAnalyzerTraceDisplay.this.mousePressX = e.getX ();
//      JDefaultSpectrumAnalyzerTraceDisplay.this.mousePressY = e.getY ();
//    }
//    
//    @Override
...
//      if (JDefaultSpectrumAnalyzerTraceDisplay.this.manager != null)
//      {
//        final int x1 = JDefaultSpectrumAnalyzerTraceDisplay.this.mousePressX;
//        final int x2 = e.getX ();
//        final int y1 = JDefaultSpectrumAnalyzerTraceDisplay.this.mousePressY;
//        final int y2 = e.getY ();
...
//        {
//          case MouseEvent.BUTTON1:
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton1Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          case MouseEvent.BUTTON2:
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton2Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          case MouseEvent.BUTTON3:
//            JDefaultSpectrumAnalyzerTraceDisplay.this.manager.mouseButton3Dragged (f1_MHz, f2_MHz, S1_dBm, S2_dBm);
//            break;
//          default:
//            break;
//        }
