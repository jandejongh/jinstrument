...
/** A Swing panel for Output settings of a {@link RS_ESH3_GPIB_Instrument} Selective Level Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JRS_ESH3_GPIB_Output
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JRS_ESH3_GPIB_Output.class.getName ());
    ...
    final Color panelColor)
  {
    ...
    add (new JRS_ESH3_GPIB_DataOutputMode (
      rs_esh3,
      "Data Output Mode",
      level + 1,
      JInstrumentPanel.getGuiPreferencesAmplitudeColor ()));
    
    add (new JRS_ESH3_GPIB_DataOuputMode_Field (
      rs_esh3,
  ...
  public JRS_ESH3_GPIB_Output (final RS_ESH3_GPIB_Instrument selectiveLevelMeter, final int level)
  {
    this (selectiveLevelMeter, null, level, null);
  }
  
  public JRS_ESH3_GPIB_Output (final RS_ESH3_GPIB_Instrument selectiveLevelMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "R&S ESH-3 [GPIB] Output Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof RS_ESH3_GPIB_Instrument))
        return new JRS_ESH3_GPIB_Output ((RS_ESH3_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JRS_ESH3_GPIB_Output.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
