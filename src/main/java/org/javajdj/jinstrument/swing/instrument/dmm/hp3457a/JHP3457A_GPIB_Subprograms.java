...
/** A Swing panel for Subprograms Settings of a {@link HP3457A_GPIB_Instrument} Digital Multi Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JHP3457A_GPIB_Subprograms
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JHP3457A_GPIB_Subprograms.class.getName ());
  ...
  public JHP3457A_GPIB_Subprograms (
  ...
  public JHP3457A_GPIB_Subprograms (final HP3457A_GPIB_Instrument digitalMultiMeter, final int level)
  {
    this (digitalMultiMeter, null, level, null);
  }
  
  public JHP3457A_GPIB_Subprograms (final HP3457A_GPIB_Instrument digitalMultiMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "HP-3457A [GPIB] Subprograms Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof HP3457A_GPIB_Instrument))
        return new JHP3457A_GPIB_Subprograms ((HP3457A_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JHP3457A_GPIB_Subprograms.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
