  ...
  private final InstrumentListener instrumentListener = new InstrumentListener ()
  {
    ...
    public void newInstrumentSettings (final Instrument instrument, final InstrumentSettings instrumentSettings)
    {
      ...
      SwingUtilities.invokeLater (() ->
      {
        ...
        try
        {
          JTek2440_GPIB_Measurement.this.jSequencerFormat.setDisplayedValue (
            settings.isSequencerFormatCharsEnabled ());
          JTek2440_GPIB_Measurement.this.jSequencerActions.setDisplayedValue (
            settings.getSequencerActionsAsInt ());
          JTek2440_GPIB_Measurement.this.jSequencerForce.setDisplayedValue (
