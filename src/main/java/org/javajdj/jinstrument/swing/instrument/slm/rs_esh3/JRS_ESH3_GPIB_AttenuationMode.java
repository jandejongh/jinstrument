...
/** A Swing panel for the Attenuation Mode [LowNoise/LowDist/Auto] settings
 *    of a {@link RS_ESH3_GPIB_Instrument} Selective Level Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JRS_ESH3_GPIB_AttenuationMode
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JRS_ESH3_GPIB_AttenuationMode.class.getName ());
  ...
  public JRS_ESH3_GPIB_AttenuationMode (
    ...
    final Color panelColor)
  {
    ...
    add (JCenter.XY (new JEnum_JComboBox<> (
      RS_ESH3_GPIB_Settings.AttenuationMode.class,
      "Attenuation Mode",
      (final InstrumentSettings settings) -> ((RS_ESH3_GPIB_Settings) settings).getAttenuationMode (),
      rs_esh3::setAttenuationMode,
      true)));

  }

  public JRS_ESH3_GPIB_AttenuationMode (final RS_ESH3_GPIB_Instrument selectiveLevelMeter, final int level)
  {
    this (selectiveLevelMeter, null, level, null);
  }
  
  public JRS_ESH3_GPIB_AttenuationMode (final RS_ESH3_GPIB_Instrument selectiveLevelMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "R&S ESH-3 [GPIB] Attenuation Mode Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof RS_ESH3_GPIB_Instrument))
        return new JRS_ESH3_GPIB_AttenuationMode ((RS_ESH3_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JRS_ESH3_GPIB_AttenuationMode.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
