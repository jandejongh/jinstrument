...
/** A Swing panel for Discrete Sweep Table settings of a {@link HP3325B_GPIB_Instrument} Function Generator.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JHP3325B_GPIB_DST
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JHP3325B_GPIB_DST.class.getName ());
    ...
    final Color panelColor)
  {
    ...
    add (new JInstrumentPanel (
      ...
      new JVoid_JColorCheckBox (
        "Clear DST",
        hp3325b::discreteSweepTableClear,
        Color.blue)));
    
    add (JCenter.XY (new JLabel ("Store [TBD]")));
    
    add (JCenter.XY (new JLabel ("Recall [TBD")));
    
  }

  public JHP3325B_GPIB_DST (final HP3325B_GPIB_Instrument functionGenerator, final int level)
  {
    this (functionGenerator, null, level, null);
  }
  
  public JHP3325B_GPIB_DST (final HP3325B_GPIB_Instrument functionGenerator)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "HP-3325B [GPIB] Discrete Sweep Table Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof HP3325B_GPIB_Instrument))
        return new JHP3325B_GPIB_DST ((HP3325B_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JHP3325B_GPIB_DST.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
