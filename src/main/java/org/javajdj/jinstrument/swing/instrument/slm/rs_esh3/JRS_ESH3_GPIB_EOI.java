...
/** A Swing panel for the EOI settings
 *    of a {@link RS_ESH3_GPIB_Instrument} Selective Level Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JRS_ESH3_GPIB_EOI
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JRS_ESH3_GPIB_EOI.class.getName ());
    ...
    final Color panelColor)
  {
    ...
    add (JCenter.XY (JCenter.Y (new JBoolean_JBoolean (
      "EOI",
      (settings) -> ((RS_ESH3_GPIB_Settings) settings).isEoi (),
      rs_esh3::setEoi,
      Color.green,
      true))));
  ...
  public JRS_ESH3_GPIB_EOI (final RS_ESH3_GPIB_Instrument selectiveLevelMeter, final int level)
  {
    this (selectiveLevelMeter, null, level, null);
  }
  
  public JRS_ESH3_GPIB_EOI (final RS_ESH3_GPIB_Instrument selectiveLevelMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "R&S ESH-3 [GPIB] EOI Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof RS_ESH3_GPIB_Instrument))
        return new JRS_ESH3_GPIB_EOI ((RS_ESH3_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JRS_ESH3_GPIB_EOI.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
