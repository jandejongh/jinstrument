...
/** A Swing panel for the Modulation Source Waveform setting of a {@link HP3325B_GPIB_Instrument} Function Generator.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JHP3325B_GPIB_ModulationSourceWaveform
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JHP3325B_GPIB_ModulationSourceWaveform.class.getName ());
  ...
  public JHP3325B_GPIB_ModulationSourceWaveform (
  ...
  public JHP3325B_GPIB_ModulationSourceWaveform (final HP3325B_GPIB_Instrument functionGenerator, final int level)
  {
    this (functionGenerator, null, level, null);
  }
  
  public JHP3325B_GPIB_ModulationSourceWaveform (final HP3325B_GPIB_Instrument functionGenerator)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "HP-3325B [GPIB] Modulation Source Waveform Setting";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof HP3325B_GPIB_Instrument))
        return new JHP3325B_GPIB_ModulationSourceWaveform ((HP3325B_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JHP3325B_GPIB_ModulationSourceWaveform.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
