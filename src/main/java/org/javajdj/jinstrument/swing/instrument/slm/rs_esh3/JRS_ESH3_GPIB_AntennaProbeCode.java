...
/** A Swing panel for the Antenna/Probe Code settings
 *    of a {@link RS_ESH3_GPIB_Instrument} Selective Level Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JRS_ESH3_GPIB_AntennaProbeCode
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JRS_ESH3_GPIB_AntennaProbeCode.class.getName ());
  ...
  public JRS_ESH3_GPIB_AntennaProbeCode (
    ...
    final Color panelColor)
  {
    ...
    add (JCenter.XY (JCenter.Y (new JBoolean_JBoolean (
      "Antenna/Probe Code",
      (settings) -> ((RS_ESH3_GPIB_Settings) settings).isAntennaProbeCode (),
      rs_esh3::setAntennaProbeCode,
      Color.green,
      true))));
    
  }

  public JRS_ESH3_GPIB_AntennaProbeCode (final RS_ESH3_GPIB_Instrument selectiveLevelMeter, final int level)
  {
    this (selectiveLevelMeter, null, level, null);
  }
  
  public JRS_ESH3_GPIB_AntennaProbeCode (final RS_ESH3_GPIB_Instrument selectiveLevelMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "R&S ESH-3 [GPIB] Antenna/Probe Code Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof RS_ESH3_GPIB_Instrument))
        return new JRS_ESH3_GPIB_AntennaProbeCode ((RS_ESH3_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JRS_ESH3_GPIB_AntennaProbeCode.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
