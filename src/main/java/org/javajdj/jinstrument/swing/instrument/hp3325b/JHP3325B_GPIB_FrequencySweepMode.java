...
/** A Swing panel for the Frequency Sweep Mode setting of a {@link HP3325B_GPIB_Instrument} Function Generator.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JHP3325B_GPIB_FrequencySweepMode
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JHP3325B_GPIB_FrequencySweepMode.class.getName ());
  ...
  public JHP3325B_GPIB_FrequencySweepMode (
  ...
  public JHP3325B_GPIB_FrequencySweepMode (final HP3325B_GPIB_Instrument functionGenerator, final int level)
  {
    this (functionGenerator, null, level, null);
  }
  
  public JHP3325B_GPIB_FrequencySweepMode (final HP3325B_GPIB_Instrument functionGenerator)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "HP-3325B [GPIB] Frequency Sweep Mode Setting";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof HP3325B_GPIB_Instrument))
        return new JHP3325B_GPIB_FrequencySweepMode ((HP3325B_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JHP3325B_GPIB_FrequencySweepMode.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
