...
/** A Swing panel for [Max/Min] Level settings of a {@link RS_ESH3_GPIB_Instrument} Selective Level Meter.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class JRS_ESH3_GPIB_Levels
  ...
  implements InstrumentView
{
  ...
  private static final Logger LOG = Logger.getLogger (JRS_ESH3_GPIB_Levels.class.getName ());
    ...
    final Color panelColor)
  {
    ...
    add (new JRS_ESH3_GPIB_MaxMinMode (
      rs_esh3,
      "Max/Min Mode",
      level + 1,
      JInstrumentPanel.getGuiPreferencesAmplitudeColor ()));
    
    add (new JRS_ESH3_GPIB_MinLevel (
      rs_esh3,
      "Min Level",
      level + 1,
      JInstrumentPanel.getGuiPreferencesAmplitudeColor ()));
    
    add (new JRS_ESH3_GPIB_MaxLevel (
      rs_esh3,
      "Max Level",
      level + 1,
      JInstrumentPanel.getGuiPreferencesAmplitudeColor ()));
  ...
  public JRS_ESH3_GPIB_Levels (final RS_ESH3_GPIB_Instrument selectiveLevelMeter, final int level)
  {
    this (selectiveLevelMeter, null, level, null);
  }
  
  public JRS_ESH3_GPIB_Levels (final RS_ESH3_GPIB_Instrument selectiveLevelMeter)
  {
  ...
  public final static InstrumentViewType INSTRUMENT_VIEW_TYPE = new InstrumentViewType ()
  {
    ...
    {
      return "R&S ESH-3 [GPIB] Levels Settings";
    }
    ...
    public final InstrumentView openInstrumentView (final Instrument instrument)
    {
      if (instrument != null && (instrument instanceof RS_ESH3_GPIB_Instrument))
        return new JRS_ESH3_GPIB_Levels ((RS_ESH3_GPIB_Instrument) instrument);
      else
        return null;
    }
  ...
  {
    return JRS_ESH3_GPIB_Levels.INSTRUMENT_VIEW_TYPE.getInstrumentViewTypeUrl ()
      + "<>"
