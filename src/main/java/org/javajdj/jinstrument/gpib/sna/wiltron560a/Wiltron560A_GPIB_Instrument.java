...
import org.javajdj.jinstrument.gpib.sna.AbstractGpibScalarNetworkAnalyzer;

/** Implementation of {@link Instrument} and {@link ScalarNetworkAnalyzer} for the Wiltron-560A.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class Wiltron560A_GPIB_Instrument
extends AbstractGpibScalarNetworkAnalyzer
implements ScalarNetworkAnalyzer
{
  ...
  private static final Logger LOG = Logger.getLogger (Wiltron560A_GPIB_Instrument.class.getName ());
  ...
  public Wiltron560A_GPIB_Instrument (final GpibDevice device)
  {
    super ("Wiltron-560A", device, null, null, false, false, false, false, false, false, true);
  }
  ...
  public final static InstrumentType INSTRUMENT_TYPE = new InstrumentType ()
  {
    ...
    @Override
    public final Wiltron560A_GPIB_Instrument openInstrument (final Device device)
    {
      ...
      return new Wiltron560A_GPIB_Instrument ((GpibDevice) device);
    }
  ...
  {
    return Wiltron560A_GPIB_Instrument.INSTRUMENT_TYPE.getInstrumentTypeUrl () + "@" + getDevice ().getDeviceUrl ();
  }
