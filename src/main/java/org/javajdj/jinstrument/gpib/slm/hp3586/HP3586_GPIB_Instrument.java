 ...
 * 
 */
package org.javajdj.jinstrument.gpib.slm.hp3586;
...
/** Implementation of {@link Instrument} and {@link SelectiveLevelMeter} for the HP-3586.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class HP3586_GPIB_Instrument
...
implements SelectiveLevelMeter
{
  ...
  private static final Logger LOG = Logger.getLogger (HP3586_GPIB_Instrument.class.getName ());
  ...
  public HP3586_GPIB_Instrument (final GpibDevice device)
  {
    super ("HP-3586", device, null, null, false, false, false, false /* XXX */ /* true, true, true, false */);
  }
  ...
  public final static InstrumentType INSTRUMENT_TYPE = new InstrumentType ()
  {
    ...
    @Override
    public final HP3586_GPIB_Instrument openInstrument (final Device device)
    {
      ...
      return new HP3586_GPIB_Instrument ((GpibDevice) device);
    }
  ...
  {
    return HP3586_GPIB_Instrument.INSTRUMENT_TYPE.getInstrumentTypeUrl () + "@" + getDevice ().getDeviceUrl ();
  }
