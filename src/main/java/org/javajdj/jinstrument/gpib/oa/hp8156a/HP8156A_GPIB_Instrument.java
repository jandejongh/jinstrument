 ...
 * 
 */
package org.javajdj.jinstrument.gpib.oa.hp8156a;
...
import org.javajdj.jinstrument.OpticalAttenuator;
import org.javajdj.jinstrument.controller.gpib.DeviceType_GPIB;
import org.javajdj.jinstrument.gpib.oa.AbstractGpibOpticalAttenuator;

/** Implementation of {@link Instrument} and {@link OpticalAttenuator} for the HP-8156A.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class HP8156A_GPIB_Instrument
extends AbstractGpibOpticalAttenuator
implements OpticalAttenuator
{
  ...
  private static final Logger LOG = Logger.getLogger (HP8156A_GPIB_Instrument.class.getName ());
  ...
  public HP8156A_GPIB_Instrument (final GpibDevice device)
  {
    super ("HP-8156A", device, null, null, false, false, false, false /* XXX */ /* true, true, true, false */);
  }
  ...
  public final static InstrumentType INSTRUMENT_TYPE = new InstrumentType ()
  {
    ...
    @Override
    public final HP8156A_GPIB_Instrument openInstrument (final Device device)
    {
      ...
      return new HP8156A_GPIB_Instrument ((GpibDevice) device);
    }
  ...
  {
    return HP8156A_GPIB_Instrument.INSTRUMENT_TYPE.getInstrumentTypeUrl () + "@" + getDevice ().getDeviceUrl ();
  }
