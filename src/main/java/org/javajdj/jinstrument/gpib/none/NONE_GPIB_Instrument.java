 ...
 * 
 */
package org.javajdj.jinstrument.gpib.none;
 ...
 *
 * <p>
 * The main purpose of this class is to allow instrument-agnostic access to GPIB controllers
 * and GPIB devices.
 * 
 * <p>
 * It is also useful as a template for implementation of {@link Instrument} for
 * GPIB instruments that do not resemble any of the other
 * abstract base class for GPIB instruments.
 * 
...
implements Instrument
{
  ...
  private static final Logger LOG = Logger.getLogger (NONE_GPIB_Instrument.class.getName ());
  ...
  {
    super ("NONE [GPIB]", gpibDevice, null, null, false, false, false, false, false, false, false);
  }
  ...
  public final static InstrumentType INSTRUMENT_TYPE = new InstrumentType ()
  {
    ...
    @Override
    public final NONE_GPIB_Instrument openInstrument (final Device device)
    {
      ...
      return new NONE_GPIB_Instrument ((GpibDevice) device);
    }
  ...
  {
    return NONE_GPIB_Instrument.INSTRUMENT_TYPE.getInstrumentTypeUrl () + "@" + getDevice ().getDeviceUrl ();
  }
