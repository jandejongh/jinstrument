 ...
 * 
 */
package org.javajdj.jinstrument.gpib.dcl.hp6050a;

import java.io.IOException;
import java.util.concurrent.TimeoutException;
import java.util.logging.Level;
import java.util.logging.Logger;
import org.javajdj.jinstrument.DCLoad;
...
import org.javajdj.jinstrument.gpib.dcl.AbstractGpibDCLoad;

/** Implementation of {@link Instrument} and {@link DCLoad} for the HP-6050A.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public class HP6050A_GPIB_Instrument
extends AbstractGpibDCLoad
implements DCLoad
{
  ...
  private static final Logger LOG = Logger.getLogger (HP6050A_GPIB_Instrument.class.getName ());
  ...
  public HP6050A_GPIB_Instrument (final GpibDevice device)
  {
    super ("HP-6050A", device, null, null, false, false, false, false /* XXX */ /* true, true, true, false */);
  }
  ...
  public final static InstrumentType INSTRUMENT_TYPE = new InstrumentType ()
  {
    ...
    @Override
    public final HP6050A_GPIB_Instrument openInstrument (final Device device)
    {
      ...
      return new HP6050A_GPIB_Instrument ((GpibDevice) device);
    }
  ...
  {
    return HP6050A_GPIB_Instrument.INSTRUMENT_TYPE.getInstrumentTypeUrl () + "@" + getDevice ().getDeviceUrl ();
  }
