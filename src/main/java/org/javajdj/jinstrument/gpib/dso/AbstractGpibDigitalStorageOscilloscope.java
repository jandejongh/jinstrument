 ...
 * 
 */
package org.javajdj.jinstrument.gpib.dso;
...
/** Abstract base implementation of a {@link DigitalStorageOscilloscope} for GPIB instruments.
 *
 * @author Jan de Jongh {@literal <jfcmdejongh@gmail.com>}
 * 
 */
public abstract class AbstractGpibDigitalStorageOscilloscope
  ...
  implements DigitalStorageOscilloscope
{
  ...
  private static final Logger LOG = Logger.getLogger (AbstractGpibDigitalStorageOscilloscope.class.getName ());
  ...
  protected AbstractGpibDigitalStorageOscilloscope (
    final String name,
