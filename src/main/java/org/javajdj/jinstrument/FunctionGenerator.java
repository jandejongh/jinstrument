  ...
  extends Instrument
{
  ...
  double getMinAmplitude_Vpp ();
  
  double getMaxAmplitude_Vpp ();
  
  void setAmplitude_Vpp (double amplitude_Vpp)
    throws IOException, InterruptedException;
  ...
  boolean supportsDCOffset ();
  
  double getMinDCOffset_V ();
  
  double getMaxDCOffset_V ();
  
  void setDCOffset_V (double dcOffset_V)
    throws IOException, InterruptedException;
